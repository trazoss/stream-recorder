...
def stream(url):
	...
	format_string = 'ffmpeg  -i ' + url + ' -map 0:V -map 0:m:variant_bitrate:3396000 -c copy -bsf:a aac_adtstoasc ' + '/downloads' + '/' + str(now.hour) + str(now.minute) + str(now.second) + '.flv'

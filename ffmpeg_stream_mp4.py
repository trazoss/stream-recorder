...
def stream(url):
	...
	format_string = 'ffmpeg  -i ' + url + ' -map m:Video:h264 m:variant_bitrate:3396000 -c copy -bsf:a aac_adtstoasc ' + '/downloads' + '/' + str(now.hour) + str(now.minute) + str(now.second) + '.flv'
